...
| Why is my project always pending? | An administrator can change its status through the admin panel. It shouldn't change otherwise. | 
...
| How do I set a due date/deadline for a project? | An admin can set a deadline/due date via the admin panel by manipulating semester objects. | 
