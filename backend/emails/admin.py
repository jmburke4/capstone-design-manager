...
class EmailAdminSite(admin.AdminSite):
    def get_urls(self):
        ...
        custom_urls = [
            ...
            path('send-project-presentation/', self.admin_view(self.send_project_presentation_view), name='send_project_presentation'),
        ]
    ...
    def send_sponsor_outreach_view(self, request):
        ...
        return render(request, 'admin/email_form.html', {
    ...
    def send_project_presentation_view(self, request):
        ...
        return render(request, 'admin/project_email_form.html', {
