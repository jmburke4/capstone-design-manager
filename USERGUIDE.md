...
This guide includes screenshots to help you navigate the application. The screenshots are referenced throughout each section.

**Where to place images:**
- Save all screenshots in the folder: `docs/assets/user-guide/`

**Create subfolders for each user type:**
- `docs/assets/user-guide/student/` - Store student-related screenshots here
- `docs/assets/user-guide/sponsor/` - Store sponsor-related screenshots here  
- `docs/assets/user-guide/admin/` - Store admin-related screenshots here

**Image naming conventions (required):**
- Use only lowercase letters
- Use hyphens (-) to separate words
- Example: `student-dashboard.png`, `sponsor-projects-form.png`, `admin-projects-list.png`
...
The Capstone Design Manager is a web-based application developed for the University of Alabama Computer Science department. Its primary purpose is to facilitate the management of senior design projects by connecting enrolled students with external sponsors who provide project ideas.

This system streamlines the entire process of project submission, student preference gathering, automated matching, and ongoing project management. It serves as a centralized platform where sponsors can propose projects, students can express their interests, and administrators can oversee the entire process from beginning to end.
...
| **Sponsor** | An external professional from a company or organization who submits project ideas for students to work on | Submit projects, provide feedback, track progress |
...
Sponsors log into the system and submit their project proposals. Each sponsor can submit multiple projects based on their organization's needs and the limit set by the administrator.
...
|---------|-----|-------------|
| Frontend Application | http://localhost:5173 | The main web application |
| Admin Panel | http://localhost:8000/admin | Django admin interface |
| REST API | http://localhost:8000/api/v1/ | API endpoints |
| Email Testing (Mailhog) | http://localhost:8025 | View sent emails |
